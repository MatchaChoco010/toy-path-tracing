...
pub fn create_scene_12(
    ...
    let floor = scene.add_mesh(load_gltf(Path::new("assets/models/floor.glb"))?);
    scene.add_instance(floor, wall_gray, Mat4::IDENTITY);
    let ceiling = scene.add_mesh(load_gltf(Path::new("assets/models/ceiling.glb"))?);
    scene.add_instance(ceiling, wall_gray, Mat4::IDENTITY);
    let back_wall = scene.add_mesh(load_gltf(Path::new("assets/models/back-wall.glb"))?);
    scene.add_instance(back_wall, wall_gray, Mat4::IDENTITY);
    let left_wall = scene.add_mesh(load_gltf(Path::new("assets/models/left-wall.glb"))?);
    scene.add_instance(left_wall, red, Mat4::IDENTITY);
    let right_wall = scene.add_mesh(load_gltf(Path::new("assets/models/right-wall.glb"))?);
