//! OpenPBR の low-poly 単体バニーで、dispersion scale 0.75 の透明 glass を IBL とエリアライトで表示する。
...
pub fn create_scene_64() -> Result<(Scene, PinholeCamera), Box<dyn Error>> {
    create_single_openpbr_low_bunny_scene(
        OpenPbrMaterial::new(Vec3::ZERO)
            ...
            .with_transmission_dispersion_scale(0.75),
    )
}
